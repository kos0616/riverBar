<template>
  <div class="flex flex-col gap-4 md:flex-row">
    ...
    >
      <div
        v-if="Array.isArray(data1) && data1?.length"
        class="grid flex-1 grid-cols-2 rounded-md py-2 shadow-sm md:block md:border-4 md:border-el-warning md:bg-el-warning md:p-2"
      >
