  ...
  <main>
    <div class="mx-auto w-full">
      <div class="grid p-3">
        ...
        <div class="mb-3 flex items-center overflow-hidden rounded-full bg-white lg:hidden">
...
import GetLocationCameras from '@/CUSTOMER/Service/Location/GetLocationCameras';
...
const allCameras = ref<Awaited<ReturnType<typeof GetLocationCameras>>>([]);
